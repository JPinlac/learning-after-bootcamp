...
According to the [Bureau of Labor Statistics](http://www.bls.gov/ooh/computer-and-information-technology/software-developers.htm), the median pay of software developers is $98,000 for 2014 with an expected growth of 17% from 2014 to 2024 with is much faster than average. The expected growth of web developer jobs is 27%. Those numbers looks exceptionally good to me. Good enough that I'm constantly kicking myself in the ass because I didn't start seriously programming sooner.

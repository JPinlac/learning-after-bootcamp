...
###### Portfolio Site http://jonathan.pinlac.net - In progress
...
###### bella beauty co. Site - in progress
...
*Operating System*  
My environment is odd. At work I use Windows 8. My laptop has Windows 10 and Linux Mint 17.2 on it. Throughout the bootcamp I strictly used linux. I decided to force myself to learn linux since that's what most web server's will be running, so might as well get familiar with it.
